...
class ArrayFrob
{
    ...
    {
        /*
         * Possible Conversions:* List<Integer> -> List<Integer>* List<Integer>
         * -> int[]* List<Integer> -> Integer[]* int[] -> int[]* int[] ->
         * List<Integer>* int[] -> Integer[]* Integer[] -> Integer[]* Integer[]
        ...
        throw new IllegalArgumentException(MessageFormat.format(
                _("Not An Expected Convertion type from {0} to {1}"), new Object[] {
                        o.getClass(), c
                }));
    }
