...
public class DirectConnection extends AbstractConnection
{
     ...
     *            address, except that the additional parameter 'listen=true'
     *            should be added in the application which is creating the
     *            socket.
     */
    ...
    {
        try {
            DBus.Introspectable intro = (DBus.Introspectable) getRemoteObject(path,
            ...
            throw new DBusException(MessageFormat.format(
                    _("Failed to create proxy object for {0}; reason: {1}."), new Object[] {
                            path, e.getMessage()
                    }));
        }
    }
     ...
     */
    public DBusInterface getRemoteObject(String objectpath, Class<? extends DBusInterface> type)
