...
public class Variant<T>
{
     ...
     * @throws IllegalArugmentException If you try and wrap Null or an object of
     *             a non-basic type.
     */
    public Variant(T o) throws IllegalArgumentException
    {
        if (null == o)
            throw new IllegalArgumentException(_("Can't wrap Null in a Variant"));
        type = o.getClass();
        try {
     ...
     * @throws IllegalArugmentException If you try and wrap Null or an object
